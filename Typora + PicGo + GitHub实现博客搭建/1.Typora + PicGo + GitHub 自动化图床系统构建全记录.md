...
![image-20260422133255798](E:\Web_git\env-setup\Typora + PicGo + GitHub实现博客搭建\1.Typora + PicGo + GitHub 自动化图床系统构建全记录.assets\image-20260422133255798.png)
...
- ![image-20260422133627048](E:\Web_git\env-setup\Typora + PicGo + GitHub实现博客搭建\1.Typora + PicGo + GitHub 自动化图床系统构建全记录.assets\image-20260422133627048.png)设置成功后下滑点击生成，出现下面界面，此时要**<u>保存Token,后续PicGo需要使用</u>**

- **⚠️ 核心提醒**：生成的 `ghp_` 开头长字符只会出现一次，必须立即保存到记事本 。

![image-20260422133639947](E:\Web_git\env-setup\Typora + PicGo + GitHub实现博客搭建\1.Typora + PicGo + GitHub 自动化图床系统构建全记录.assets\image-20260422133639947.png)
...
![image-20260422135645147](E:\Web_git\env-setup\Typora + PicGo + GitHub实现博客搭建\1.Typora + PicGo + GitHub 自动化图床系统构建全记录.assets\image-20260422135645147.png)
...
![image-20260422140906783](E:\Web_git\env-setup\Typora + PicGo + GitHub实现博客搭建\1.Typora + PicGo + GitHub 自动化图床系统构建全记录.assets\image-20260422140906783.png)
...
- 需要先下载PicGo软件
  ...
  >
  > ![image-20260422133907315](E:\Web_git\env-setup\Typora + PicGo + GitHub实现博客搭建\1.Typora + PicGo + GitHub 自动化图床系统构建全记录.assets\image-20260422133907315.png)
...
- 进入软件设置
  ...
  >
  > ![image-20260422134357271](E:\Web_git\env-setup\Typora + PicGo + GitHub实现博客搭建\1.Typora + PicGo + GitHub 自动化图床系统构建全记录.assets\image-20260422134357271.png)

- 检验：在上传区中随便提交一个照片，看github仓库中是否有对应图片

  ![image-20260422134512142](E:\Web_git\env-setup\Typora + PicGo + GitHub实现博客搭建\1.Typora + PicGo + GitHub 自动化图床系统构建全记录.assets\image-20260422134512142.png)常见问题：
...
![image-20260422134712392](E:\Web_git\env-setup\Typora + PicGo + GitHub实现博客搭建\1.Typora + PicGo + GitHub 自动化图床系统构建全记录.assets\image-20260422134712392.png)

![image-20260422134726085](E:\Web_git\env-setup\Typora + PicGo + GitHub实现博客搭建\1.Typora + PicGo + GitHub 自动化图床系统构建全记录.assets\image-20260422134726085.png)
...
![image-20260422142601615](E:\Web_git\env-setup\Typora + PicGo + GitHub实现博客搭建\1.Typora + PicGo + GitHub 自动化图床系统构建全记录.assets\image-20260422142601615.png)
